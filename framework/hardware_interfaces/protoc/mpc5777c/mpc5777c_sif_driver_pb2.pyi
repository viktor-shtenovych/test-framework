...
class SifInitParams(_message.Message):
    __slots__ = ("instance", "irq_id", "eoq_irq_id", "fault_irq_id")
    INSTANCE_FIELD_NUMBER: _ClassVar[int]
    IRQ_ID_FIELD_NUMBER: _ClassVar[int]
    EOQ_IRQ_ID_FIELD_NUMBER: _ClassVar[int]
    FAULT_IRQ_ID_FIELD_NUMBER: _ClassVar[int]
    instance: int
    irq_id: int
    eoq_irq_id: int
    fault_irq_id: int
    def __init__(self, instance: _Optional[int] = ..., irq_id: _Optional[int] = ..., eoq_irq_id: _Optional[int] = ..., fault_irq_id: _Optional[int] = ...) -> None: ...
